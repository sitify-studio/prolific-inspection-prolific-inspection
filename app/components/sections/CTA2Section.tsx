...
export const CTA2Section: React.FC<CTA2SectionProps> = ({ cta2Section, className }) => {
  ...
  const panelBg = hasBgImage
    ? `color-mix(in srgb, ${themeColors.pageBackground} 52%, transparent)`
  ...
  return (
    <section
      ...
      style={{
        backgroundColor: customBg || themeColors.pageBackground,
    ...
    >
      {backgroundImageUrl ? (
        <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
          ...
          <div
            className="absolute inset-0 bg-gradient-to-t from-[color-mix(in_srgb,var(--wb-page-bg)_35%,transparent)] via-transparent to-[color-mix(in_srgb,var(--wb-page-bg)_20%,transparent)]"
            aria-hidden
          />
        </div>
      ) : (
          ...
          <div className="mb-6 flex items-center gap-3">
            ...
            <span
              className={cn(
                ...
                hasBgImage ? 'text-[var(--wb-text-on-dark-secondary)]' : contrast.textSecondary
              )}
          ...
          {safeCta.title && (
            <h2
              ...
              className={cn(
                ...
                hasBgImage ? 'text-[var(--wb-text-on-dark)]' : contrast.textPrimary
              )}
          ...
          {safeCta.description && (
            <div
              ...
              className={cn(
                ...
                hasBgImage ? 'text-[color-mix(in_srgb,var(--wb-text-on-dark)_85%,transparent)]' : contrast.textSecondary
              )}
              style={{ fontFamily: themeFonts.body }}
            >
